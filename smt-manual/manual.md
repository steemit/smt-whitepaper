...
For content websites and tokens, incentive alignment between websites and users comes from a mathematically guaranteed and steady release of new tokens that must be allocated to the users, who could be bloggers, vloggers and curators. Quality user experience comes from tokens that can be transacted safely (through separate private keys for distinct sets of actions), *without* fees and at real-time speeds.  Further, incentive alignment also comes from a company’s ability to raise capital in ICOs, therefore the ICO contract needs to be supported natively by the token protocol.
