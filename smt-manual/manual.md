...
* Status: DRAFT
* GitHub: [link](https://github.com/steemit/smt-whitepaper/blob/master/smt-manual/manual.md)
...
Initially, `smt_creation_fee` will be set to 75 SBD, and no means will be
...
## STEEM and SMTs: The World's Advertising Network
