...
- [Introduction](#introduction)
  ...
  - [Use Cases](#use-cases)
    ...
    - [5 - Arbitrary Assets - Tokens Representing Real World Assets](#5---arbitrary-assets---tokens-representing-real-world-assets)
- [Owner's manual](#owners-manual)
  - [Create a control account](#create-a-control-account)
    - [Control account security](#control-account-security)
    - [Token consensus](#token-consensus)
  - [Token Generation and Initialized Parameters](#token-generation-and-initialized-parameters)
    - [SMT object creation](#smt-object-creation)
      - [Numerical asset identifiers](#numerical-asset-identifiers)
      - [SMT naming](#smt-naming)
      - [SMT creation fee](#smt-creation-fee)
  ...
  - [SMT Setup GUI Sketch](#smt-setup-gui-sketch)
...
- [Decentralized Exchange](#decentralized-exchange)
  ...
  - [Zero Trading and Transfer Fees](#zero-trading-and-transfer-fees)
- [Ecosystem Support](#ecosystem-support)
  - [Integrating SMTs into Websites and Apps](#integrating-smts-into-websites-and-apps)
    - [APIs and Documentation](#apis-and-documentation)
    - [Shared Tools for Account Creation, Key Signing and Wallet Functions](#shared-tools-for-account-creation-key-signing-and-wallet-functions)
- [Conclusion](#conclusion)
- [References](#references)
- [Appendix](#appendix)
  - [Implementation Notes](#implementation-notes)
    - [SMT naming standards](#smt-naming-standards)
    - [Asset directory standards](#asset-directory-standards)
    - [UI guidelines for SMT names](#ui-guidelines-for-smt-names)
    - [Operational guidelines for asset directories](#operational-guidelines-for-asset-directories)
    - [Asset directory formats](#asset-directory-formats)
...
Whether operating with bandwidth rate limiting or outright fees, no general purpose blockchain will price transactions effectively for more than a small fraction of its applications, and SMTs would have reduced UX on open-programmability blockchains, such as Eth, as a result.

Unlike, Eth, some open-programmability blockchains of the future may use bandiwdth rate limiting as transaction costs, however, bandwidth rate limiting requires fine tuning to meet UX requirements of specific applications.  As a example, in Steem, bandwidth rate limiting is specifically tailored to support media and content applications and their user interactions by leveraging bandwidth rights according to two objects: amount of token ownership and account ownership - and it’s taken over a year to refine the optimal bandwidth allowances to each. In general purpose platforms the burden and the need for accurate pricing may hinder the ability for projects to have their users' actions priced appropriately and the problem may be exacerbated as a greater myriad of potential application experiments come to exist.  Therefore, blockchains that support native specialized-programmability may yield more suitable transaction pricing as it pertains to the UX with tokens in related applications.
