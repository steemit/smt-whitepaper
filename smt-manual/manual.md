...
Some wonder how a specialized, specific-natured blockchain such as Steem, is more suited to SMTs than general purpose blockchains, such as Eth, which has shown its use for discovering new cryptocurrency concepts.  Without delving into Steem's advantages in network effect and dev team experience, the advantages for Steem can be through a set of computer science, consumer safety and economic perspectives.  As we've seen throughout histories of our world's industries, specialization, such that Steem provides, has the potential to greatly outperform generalization, such that Eth and others provide.
